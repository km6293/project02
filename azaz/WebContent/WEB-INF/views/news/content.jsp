            ...
            <div class="col-12">
                ...
                <div class="product-body">
                    ...
                    <div class="pro-detail-sec row">
                        <div class="col-12">
                            <h4 class="pro-heading text-center text-lg-left">${dto.news_title}</h4>
                            ...
                            <div class="row no-gutters product-all-details">
                                ...
                                <ul class="col-12 nav nav-tabs" id="myTab" role="tablist">
                                    <li class="col-4 nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">식품뉴스</a>
                                    </li>
                                    <li class="col-4 nav-item">
