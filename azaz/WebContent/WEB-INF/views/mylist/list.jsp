                            ...
                            <div class="row no-gutters product-all-details">
                                ...
                                <ul class="col-12 nav nav-tabs" id="myTab" role="tablist">
                                    <li class="col-4 nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">즐겨찾기</a>
                                    </li>
                                    <li class="col-4 nav-item">
                                ...
                                <div class="col-12 tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <%-- <p class="product-tab-description text-center text-lg-left">조회수 ${dto.readcount}</p>
                                        <p class="product-tab-description text-center text-lg-left">내용 : ${dto.news_writing} </p> --%>
                                        <h1>즐겨찾기</h1>

<c:forEach var="dto" items="${list}">
${dto.num}<a href="/azaz/sell/content.do?num=${dto.num}">${dto.name}</a><br/>
<button type="button" class="btn web-btn" onclick="location.href='/azaz/mylist/deletelist.do?name=${dto.name}&my_id=${sessionScope.memId}'">삭제</button><br/>
</c:forEach>
